...
func InitializeDB() {
    ...
    statement, _ := sqldb.DB.Prepare("CREATE TABLE IF NOT EXISTS clients (id INTEGER PRIMARY KEY, uuid TEXT NOT NULL UNIQUE, ipaddr TEXT, platform TEXT NOT NULL, ts_first TEXT NOT NULL, ts_last TEXT NOT NULL)")
    statement.Exec() 
